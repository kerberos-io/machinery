...
#ifndef __IoVideoOMX_H_INCLUDED__   // if IoVideoOMX.h hasn't been included yet...
#define __IoVideoOMX_H_INCLUDED__   // #define this so the compiler knows it has been included
...
namespace kerberos
{
    char VideoOMXName[] = "VideoOMX";
    class IoVideoOMX : public IoCreator<VideoOMXName, IoVideoOMX>
    {
