...
namespace kerberos
{
    void Machinery::setup(const kerberos::StringMap & settings)
    {
        ...
        VLOG(0) << "Starting conditions: " + settings.at("condition");
